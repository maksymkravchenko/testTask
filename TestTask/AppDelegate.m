...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
	...
	_webSocketService = [WebSocketService new];
	[_webSocketService startService];
...
- (NSURL *)applicationDocumentsDirectory {
	// The directory the application uses to store the Core Data store file. This code uses a directory named "pnya.urk.RightForQuality" in the application's documents directory.
